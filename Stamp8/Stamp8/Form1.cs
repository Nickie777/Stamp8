...
namespace Stamp8
{
    public partial class Form1 : Form
    {
        ...
        public Form1(string[] args, int mode)
        {
            ...
            setButtons();
            dataGridViewStamps.DataSource= StampPicturesList;
        ...
        private async void CreatePDFOnStampPicturesList()
        {
